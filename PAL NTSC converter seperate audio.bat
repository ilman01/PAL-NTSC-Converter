...
ffmpeg.exe -i %input% -vn -ac 2 %outputa%

if %mode%==1 ffmpeg -r 24000/1001 -i %input% %osra% -filter_complex "asetrate=%sr%*0.95904095904" %output%

if %mode%==2 ffmpeg -r 25 -i %input% %osra% -filter_complex "asetrate=%sr%*1.042709376" %output%
